...
export const mockProductos = [
  { id: 1, tipo: 'Remera', talle: 'M', precio: 2500, stock: 15, stock_minimo: 5 },
  { id: 2, tipo: 'Remera', talle: 'L', precio: 2500, stock: 8, stock_minimo: 5 },
  { id: 3, tipo: 'Short', talle: 'M', precio: 3000, stock: 12, stock_minimo: 5 },
  { id: 4, tipo: 'Short', talle: 'L', precio: 3000, stock: 3, stock_minimo: 5 },
  { id: 5, tipo: 'Guantes', talle: 'Único', precio: 4500, stock: 2, stock_minimo: 3 }
];